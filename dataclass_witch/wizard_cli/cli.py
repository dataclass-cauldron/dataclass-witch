...
def main(args=None):
    """
    A companion CLI tool for the Dataclass Witch, which simplifies
...
def setup_parser():
    ...
    gs_parser.add_argument(
        ...
        help=(
            "Path to JSON file. The default assumes the "
    ...
    gs_parser.add_argument(
        ...
        help=(
            "Path to new Python file. The default is to "
    ...
    gs_parser.add_argument(
        ...
        action="store_true",
        help=(
            "Do not create a separate JSON file. Note "
    ...
    gs_parser.add_argument(
        ...
        action="store_true",
        help=(
            "Force-resolve strings to inferred Python types. "
    ...
    gs_parser.add_argument(
        ...
        action="store_true",
        help=(
            "Enable experimental features via a __future__ "
...
class FileTypeWithExt(argparse.FileType):
    ...
    def __init__(self, mode="r", ext=None, bufsize=-1, encoding=None, errors="ignore"):
...
def _exit_with_error(
    ...
    msg_header = "An error{err_cls}was encountered while parsing the JSON input:"
