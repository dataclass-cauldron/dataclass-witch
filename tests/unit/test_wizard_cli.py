...
from dataclass_witch.wizard_cli import main, PyCodeGenerator
...
def mock_path(mocker: MockerFixture):
    return mocker.patch("dataclass_witch.wizard_cli.schema.Path")
...
def mock_open(mocker: MockerFixture):
    return mocker.patch("dataclass_witch.wizard_cli.cli.open")
