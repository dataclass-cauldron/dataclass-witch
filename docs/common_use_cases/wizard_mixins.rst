...
.. code:: python3
    ...
    from dataclass_witch import JSONListWizard, Container
...
.. code:: python3
    ...
    from dataclass_witch import JSONFileWizard
...
as an extra via ``pip install dataclass-witch[yaml]`` -- to easily convert
...
.. code:: python3
    ...
    from dataclass_witch import YAMLWizard
